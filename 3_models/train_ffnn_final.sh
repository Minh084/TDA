#!/bin/bash
#SBATCH -J ff_nn
#SBATCH -o /home/ccorbin/logs/ffnn_final_%A_%a.out
...
python /home/ccorbin/BMI212/notebooks/models/train_ffnn_final.py --data_dir $data_dir --label $label --model_file $dirO 