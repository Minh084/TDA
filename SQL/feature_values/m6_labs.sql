...
right join `som-nero-phi-jonc101.triageTD.cohort_enc_code_age` as cohort -- # join labs to cohort
...
or labs.base_name in ('AG', 'AGAP', 'ALB', 'ALT', 'AST', 'ALKP', 'BASO', 'BE', 'BUN', 'CA', 'CAION',  'CL','CO2','CR', 'EOS', 'GLOB', 'GLU', 'GLUURN', 'HCO3A', 'HCO3V', 'HCT', 'HGB', 'INR', 'K', 'LAC', 'LACWBL', 'LYM', 'MG', 'MONO', 'NEUT', 'O2SATA', 'O2SATV', 'PCAGP', 'PCBUN', 'PCCL', 'PCO2A', 'PCO2V', 'PH', 'PHA', 'PHCAI', 'PHV', 'PLT', 'PO2A', 'PO2V', 'PT', 'RBC', 'TBIL', 'TCO2A', 'TCO2V', 'TNI', 'TP', 'WBC', 'XLEUKEST', 'XUKET', 'NA')
